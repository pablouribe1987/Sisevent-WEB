...
public class MsUnidadesOrgACL implements Serializable{
	...
	public String toString() {
		return "MsUnidadesOrgACL [esEditable=" + esEditable + ", eliminar=" + eliminar + ", editopcion=" + editopcion
				+ "]";
	}	
