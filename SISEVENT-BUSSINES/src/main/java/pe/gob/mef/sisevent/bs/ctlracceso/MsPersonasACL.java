...
public class MsPersonasACL implements Serializable{
	...
	public String toString() {
		return "MsPersonasACL [esEditable=" + esEditable + ", eliminar=" + eliminar + ", editopcion=" + editopcion
				+ "]";
	}	
