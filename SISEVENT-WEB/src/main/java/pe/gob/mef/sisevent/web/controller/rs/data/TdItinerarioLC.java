...
public class TdItinerarioLC implements Serializable  {
	...
	public List<TdItinerarioBk> getData() {
		return data;
	}

	public void setData(List<TdItinerarioBk> data) {
		this.data = data;
	}
