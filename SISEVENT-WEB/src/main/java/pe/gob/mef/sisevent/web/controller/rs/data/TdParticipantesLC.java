...
@XmlRootElement
public class TdParticipantesLC implements Serializable  {

	protected long contador = 0;
	private long tiempoenBD = 0;
	private long tiempoenproceso = 0;
	private boolean creamodifica = false;
	protected List<TdParticipantesBk> data = null;
	
	public TdParticipantesLC() {
	}
	...
	public List<TdParticipantesBk> getData() {
		return data;
	}

	public void setData(List<TdParticipantesBk> data) {
		this.data = data;
	}
